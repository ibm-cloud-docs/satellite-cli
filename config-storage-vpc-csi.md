...
1. Open the [{{site.data.keyword.satelliteshort}} console](){: external} in your browser.
...
1. Verify that your storage configuration is deployed to your cluster. 
    1. From the [{{site.data.keyword.satelliteshort}} console](){: external}, navigate to the **Configurations** tab.
